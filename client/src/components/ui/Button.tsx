...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary:
      'bg-amber-500 text-white hover:bg-amber-600 focus:ring-amber-400 shadow-sm hover:shadow',
    outline:
      'border border-slate-300 text-slate-700 hover:bg-slate-100 focus:ring-slate-400 bg-white',
    danger:
